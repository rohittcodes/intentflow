  ...
  try {
    ...
    if (!workflow) {
      try {
        ...
        // Not a valid Convex ID, ignore error
      }
    }
    ...
    // Delete using Convex ID (moveToTrash is handled by deleteWorkflow mutation)
...
/**
 * PATCH /api/workflows - Update workflow metadata (name, description)
 */
export async function PATCH(request: NextRequest) {
  try {
    ...
    // Call updateMetadata mutation
    await convex.mutation(api.workflows.updateMetadata, {
