  ...
  return (
    <div className="flex-1 overflow-y-auto custom-scrollbar bg-accent-white w-[260px]">
      <div className="p-3 space-y-4">
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-2 py-1 bg-background border border-border rounded-md text-[11px] text-foreground outline-none focus:border-primary transition-colors"
              />
            </div>
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider block">
              ...
              <textarea
                ...
                rows={2}
                className="w-full px-2 py-1 bg-background border border-border rounded-md text-[11px] text-foreground outline-none focus:border-primary transition-colors resize-none"
        ...
        {/* Canvas Preferences */}
        <SettingsSection label="Canvas & Editor" icon={<Grid3X3 className="w-4 h-4" />}>
          <div className="space-y-4">
              ...
              <div className="flex gap-4 bg-background">
                {(['dots', 'lines', 'none'] as const).map((style) => (
                  <button
                    ...
                    className={`flex-1 py-1.5 text-[10px] font-bold uppercase rounded-6 transition-all ${gridStyle === style
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-1.5 bg-background border border-border rounded-md text-xs text-foreground outline-none focus:border-primary transition-colors appearance-none cursor-pointer"
              >
        ...
        {/* Execution Settings */}
        <SettingsSection label="Execution Limits" icon={<Zap className="w-4 h-4" />}>
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-2 py-1 bg-background border border-border rounded-md text-xs text-foreground outline-none focus:border-primary transition-colors"
              />
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
        ...
        {/* Financial Guardrails */}
        <SettingsSection label="Financial Guardrails" icon={<Shield className="w-4 h-4" />}>
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
            ...
            {(maxTokens > 0 || maxRuntimeSeconds > 0) && (
              <div className="flex items-start gap-2 p-10 bg-secondary border border-primary/20 rounded-md">
        ...
        {/* Webhooks Config */}
        <SettingsSection label="Webhooks" icon={<Zap className="w-4 h-4" />}>
          <div className="space-y-3">
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider block">
                Success Webhook
        ...
        {/* Embeddable UI */}
        <SettingsSection label="Embeddable" icon={<Maximize2 className="w-4 h-4" />}>
          <div className="space-y-4">
            <ToggleItem
            ...
            {workflow?.settings?.isEmbeddable && (
              <div className="space-y-8">
                ...
                <div className="relative group">
                  <pre className="w-full p-3 bg-background border border-border rounded-md text-[11px] font-mono text-foreground/64 overflow-x-auto">
        ...
        <div className="pt-8">
          ...
          >
            ...
            <ExternalLink className="w-3.5 h-3.5 text-primary opacity-40 group-hover:opacity-100 transition-opacity" />
          </button>
        </div>
