          ...
          <>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-12 py-10 bg-background border border-border rounded-md text-sm text-foreground font-mono focus:outline-none focus:border-primary transition-colors"
              />
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-44 h-24 rounded-full transition-colors relative ${includeContent ? 'bg-primary' : 'bg-muted'
                  }`}
              >
                <motion.div
        ...
        {nodeType.includes('guardrail') && (
          <>
            ...
            <div>
              ...
              <div className="flex items-center gap-8 px-12 py-10 bg-background border border-border rounded-md">
                <svg className="w-16 h-16 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span className="text-xs text-foreground font-mono">{inputAsText}</span>
                <span className="ml-auto px-8 py-4 bg-secondary text-primary rounded-6 text-xs font-medium">
                  STRING
                </span>
              </div>
            ...
            <div className="space-y-12">
              {/* PII Detection */}
              <div className="p-16 bg-accent-white border border-border rounded-xl">
                <div className="flex items-center justify-between mb-12">
                  ...
                  <button
                    ...
                    className={`w-44 h-24 rounded-full transition-colors relative ${piiEnabled ? 'bg-primary' : 'bg-muted'
                      }`}
                  >
                    <motion.div
                      className="w-20 h-20 bg-white rounded-full absolute top-2 shadow-sm"
                ...
                <button
                  ...
                  className="w-full px-12 py-8 bg-secondary hover:bg-secondary/80 border border-primary rounded-md text-xs text-primary transition-colors flex items-center justify-center gap-6 mb-12"
                >
                ...
                <div className="p-12 bg-secondary border border-primary rounded-md">
                  <div className="flex items-start gap-8 mb-8">
                    <svg className="w-16 h-16 text-primary flex-shrink-0 mt-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="space-y-6 mt-10">
                    <div>
                      <p className="text-xs text-primary font-medium flex items-center gap-4">
                        <span className="w-12 h-12 bg-primary rounded-full text-white text-[10px] flex items-center justify-center">✓</span>
                        Pass Example:
                      </p>
              ...
              <div className="p-16 bg-accent-white border border-border rounded-xl">
                <div className="flex items-center justify-between mb-12">
                  ...
                  <button
                    ...
                    className={`w-44 h-24 rounded-full transition-colors relative ${moderationEnabled ? 'bg-primary' : 'bg-muted'
                      }`}
                  >
                    <motion.div
                      className="w-20 h-20 bg-white rounded-full absolute top-2 shadow-sm"
              ...
              <div className="p-16 bg-accent-white border border-border rounded-xl">
                <div className="flex items-center justify-between mb-12">
                  ...
                  <button
                    ...
                    className={`w-44 h-24 rounded-full transition-colors relative ${jailbreakEnabled ? 'bg-primary' : 'bg-muted'
                      }`}
                  >
                    <motion.div
                      className="w-20 h-20 bg-white rounded-full absolute top-2 shadow-sm"
              ...
              <div className="p-16 bg-accent-white border border-border rounded-xl">
                <div className="flex items-center justify-between mb-12">
                  ...
                  <button
                    ...
                    className={`w-44 h-24 rounded-full transition-colors relative ${hallucinationEnabled ? 'bg-primary' : 'bg-muted'
                      }`}
                  >
                    <motion.div
                      className="w-20 h-20 bg-white rounded-full absolute top-2 shadow-sm"
              ...
              <div className="space-y-16 pt-16 border-t border-border">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-12 py-10 bg-background border border-border rounded-md text-sm text-foreground focus:outline-none focus:border-primary transition-colors cursor-pointer"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-12 py-10 bg-background border border-border rounded-md text-sm text-foreground placeholder-black-alpha-32 focus:outline-none focus:border-primary transition-colors resize-y font-mono"
                  />
                  <p className="text-xs text-muted-foreground mt-8">
...

        {
          showPIIModal && (
            ...
            >
              ...
              >
                {/* Header */}
                <div className="p-20 border-b border-border bg-background">
                  <div className="flex items-center justify-between">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-8">
                        {allPIIEntities.slice(0, 8).map((entity) => (
                          <label key={entity.id} className="flex items-center gap-8 p-10 hover:bg-background rounded-md cursor-pointer transition-colors">
                            <input
                              type="checkbox"
                ...
                {/* Footer */}
                <div className="p-20 border-t border-border bg-background flex justify-between items-center">
